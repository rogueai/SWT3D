...
public class LwjglSwtExample {
	...
	public static void main(final String[] args) {
		...
		// try {
		// final SimpleResourceLocator srl = new
		// SimpleResourceLocator(ResourceLocatorTool.getClassPathResource(LwjglSwtExample.class,
		...
		while (!shell.isDisposed() && !exit.isExit()) {
			...
			// using the below way makes things really jerky. Not sure how to
			// handle that.
	...
	private static void addNewCanvas(final TabFolder tabFolder, final ExampleScene scene, final FrameHandler frameWork,
		...
		// try {
		// _cursor1 = createMouseCursor(awtImageLoader,
		// "com/ardor3d/example/media/input/wait_cursor.png");
		// _cursor2 = createMouseCursor(awtImageLoader,
		// "com/ardor3d/example/media/input/movedata.gif");
...
// // enforce a single instance of SwtKeyboardWrapper will handle both the
// KeyListener and the KeyboardWrapper
// // interfaces
